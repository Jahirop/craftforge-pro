...
const TOOL_ICONS: Record<string, (props: React.SVGProps<SVGSVGElement>) => React.JSX.Element> = {
  ...
  "Canva": (props) => (
    <svg viewBox="0 0 64 64" fill="currentColor" className="w-4 h-4 mr-1.5 inline-block" {...props}>
      <style>{`.st0{fill:#24BECA;}
	.st1{fill:#FFFFFF;}`}</style>
<circle className="st0" cx="32" cy="32" r="32"/>
<path className="st1" d="M45.6,43.1c-1.7,2.3-3.9,4.7-6.8,6.5c-2.8,1.8-6,3.2-9.8,3.2c-3.5,0-6.4-1.8-8-3.3c-2.4-2.3-3.7-5.6-4.1-8.7
  ...
  "Etsy": (props) => (
    <svg viewBox="0 0 64 64" fill="currentColor" className="w-4 h-4 mr-1.5 inline-block" {...props}>
      <style>{`.st0{fill:#F27224;}`}</style>
<g>
	<path className="st0" d="M53.3,52.8c-2.7,6.1-6.6,6.5-10.9,6.5h-13c-4.3,0-6.4-1.7-6.4-5.5V34.1c0,0,9.5,0,12.8,0.3
		c2.4,0.2,3.9,0.9,4.7,4.3l1.1,4.5h3.7l-0.3-11.4l0.5-11.5h-3.7l-1.2,5c-0.8,3.3-1.3,3.9-4.7,4.3c-3.8,0.4-12.9,0.3-12.9,0.3V6.5
		c0-0.9,0.1-1.4,1.6-1.4h19.9c3.5,0,5.4,2.9,6.8,8.5l1.1,4.4h3.4C56.3,5.5,56.8,0,56.8,0s-8.5,1-13.6,1H17.8L4.1,0.5v3.7L8.8,5
		c3.2,0.6,4,1.3,4.3,4.3c0,0,0.3,8.7,0.3,23.1c0,14.3-0.3,23-0.3,23c0,2.6-1.1,3.6-4.3,4.2l-4.6,0.9V64l13.6-0.4h22.8
		c5.1,0,17,0.4,17,0.4c0.3-3.1,2-17.3,2.3-18.9h-3.2L53.3,52.8z"/>
</g>
    </svg>
  ),
  "Facebook": (props) => (
